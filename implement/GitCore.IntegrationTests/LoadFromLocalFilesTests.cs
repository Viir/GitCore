...
public class LoadFromLocalFilesTests
{
    ...
    public void Known_commit_has_expected_properties()
    {
        ...
        // Load commit 0166a832097feb94bd565354b31559ccb355e0be on main
        var commitSha = "0166a832097feb94bd565354b31559ccb355e0be";
        var repository = LoadFromLocalFiles.LoadRepository(gitDir);
        ...
        // Assert message
        commit.Message.Should().Be("parse commit properties and add API for reading commits", "Commit message should match");
    }
